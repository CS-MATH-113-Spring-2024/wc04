...
\begin{parts}
  ...
  \begin{solution}
    I: \textcolor{purple}{Some shapes are purple.}
    \[
      \begin{array}{ccc}
    \begin{array}{c|cc}
      & S(x) & P(x) \\\hline
  ...
  \begin{solution}
    O: \textcolor{purple}{Some shapes are not purple.}
    \[
      \begin{array}{ccc}
    \begin{array}{c|cc}
      & S(x) & P(x) \\\hline
  ...
  \begin{solution}
    \[
      \begin{array}{c@{\;:\;}l}
        \text{A} & \forall x(S(x) \cp{\implies} P(x))\\[5pt]
        \text{E} & \forall x(S(x) \cp{\implies} \neg P(x))\\[5pt]
        \text{I} & \exists x(S(x) \cp{\land} P(x))\\[5pt]
        \text{O} & \exists x(S(x) \cp{\land} \neg P(x))
      \end{array}
    \]
  \end{solution}
  \part[3]
  ...
  \begin{solution}
    These can be justified using De Morgan's laws and other equivalences.
